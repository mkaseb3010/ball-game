...
public class MainActivity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.i(MYDEBUG, "Got here! (MainActivity - onCreate)");
        ...
        laps = b.getInt("Number of Laps"); //added the number of laps here
        ...
        rb.configure(pathType, pathWidth, gain, orderOfControl, laps, this); //added laps here
    ...
    public void onSensorChanged(SensorEvent se)
    {
        ...
        //Determine Device Pitch and Roll (This may vary by the device sensor mode)
